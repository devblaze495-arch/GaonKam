...
export const translations: Record<LanguageCode, TranslationDictionary> = {
  mr: {
    tagline: 'ग्रामीण रोजगार आणि सेवा मंच',
    headline: 'तुमच्या गावातच काम शोधा किंवा मजूर मिळवा',
    subheadline: 'गावकाम तुम्हाला तुमच्या परिसरातील कामे, सेवा आणि विश्वासू व्यक्तींशी थेट जोडते.',
    primaryCta: 'काम शोधा',
    secondaryCta: 'काम टाका',
    navHome: 'मुख्य',
    navJobs: 'काम शोधा',
    navPostWork: 'काम टाका',
    navServices: 'सेवा मंच',
    navProfile: 'माझे प्रोफाइल',
    myPostedJobs: 'मी टाकलेली कामे',
    myApplications: 'माझे अर्ज',
    myServices: 'माझ्या सेवा',
    statsTitle: 'थेट ग्रामीण जोडणी',
    local: 'स्थानिक सहभाग',
    jobs: 'उपलब्ध कामे',
    services: 'स्थानिक सेवा',
    trust: 'विश्वासार्हता',
    recentJobs: 'नवीन कामे',
    postWorkTitle: 'नवीन काम टाका',
    postWorkSubtitle: 'तुमच्या गावातील कामगारांना थेट जोडा',
    jobTitleLabel: 'कामाचे शीर्षक',
    jobTitlePlaceholder: 'उदा. शेतात कोळपणीसाठी मजूर हवे आहेत',
    jobDescLabel: 'कामाचे वर्णन',
    jobDescPlaceholder: 'कामाबद्दल सविस्तर माहिती द्या...',
    jobCategoryLabel: 'कामाचा प्रकार',
    wageTypeLabel: 'मजुरी प्रकार',
    wageAmountLabel: 'रक्कम (₹)',
    workersNeededLabel: 'आवश्यक कामगार संख्या',
    workDateLabel: 'कामाची तारीख',
    startTimeLabel: 'कामाची वेळ',
    requiredSkillsLabel: 'आवश्यक कौशल्ये',
    postWorkSubmit: 'काम प्रकाशित करा',
    postWorkSuccess: 'काम यशस्वीरीत्या प्रकाशित केले!',
    applicantsTitle: 'उमेदवार / अर्जदार',
    noApplicantsYet: 'अद्याप कोणाचाही अर्ज आलेला नाही.',
    acceptWorker: 'स्वीकारा',
    rejectWorker: 'नकारा',
    workerAccepted: 'कामगार स्वीकारला',
    workerRejected: 'अर्ज नाकारला',
    withdrawApplication: 'अर्ज मागे घ्या',
    withdrawConfirm: 'तुम्हाला हा अर्ज मागे घ्यायचा आहे का?',
    markCompleted: 'काम पूर्ण झाले म्हणून नोंदवा',
    confirmCompletion: 'काम पूर्ण झाल्याची पुष्टी करा',
    rateWorker: 'कामगाराला रेटिंग द्या',
    rateEmployer: 'मालकाला रेटिंग द्या',
    submitRating: 'रेटिंग सबमिट करा',
    disputeTitle: 'तक्रार / वाद नोंदवा',
    disputeReason: 'तक्रारीचे कारण',
    disputeDescription: 'सविस्तर वर्णन',
    submitDispute: 'तक्रार सबमिट करा',
    ...
    deleteConfirm: 'तुम्हाला ही सेवा हटवायची आहे का?',
    allJobs: 'सर्व कामे',
    openJobs: 'उघडी कामे',
    inProgressJobs: 'सुरू असलेली कामे',
  ...
  hi: {
    tagline: 'ग्रामीण रोजगार एवं सेवा मंच',
    headline: 'अपने गांव में ही काम खोजें या मजदूर पाएं',
    subheadline: 'गांवकाम आपको अपने आसपास के काम, सेवाओं और विश्वसनीय लोगों से सीधे जोड़ता है।',
    ...
    myPostedJobs: 'मेरे पोस्ट किए काम',
    myApplications: 'मेरे आवेदन',
    myServices: 'मेरी सेवाएं',
    statsTitle: 'सीधा ग्रामीण जुड़ाव',
    local: 'स्थानीय सहभाग',
    jobs: 'उपलब्ध काम',
    services: 'स्थानीय सेवाएं',
    trust: 'विश्वसनीयता',
    recentJobs: 'नवीनतम काम',
    postWorkTitle: 'नया काम पोस्ट करें',
    postWorkSubtitle: 'अपने गांव के मजदूरों से सीधे जुड़ें',
    jobTitleLabel: 'काम का शीर्षक',
    jobTitlePlaceholder: 'उदा. खेत में काम के लिए मजदूर चाहिए',
    jobDescLabel: 'काम का विवरण',
    jobDescPlaceholder: 'काम के बारे में विस्तार से बताएं...',
    jobCategoryLabel: 'काम का प्रकार',
    wageTypeLabel: 'मजदूरी प्रकार',
    wageAmountLabel: 'राशि (₹)',
    workersNeededLabel: 'आवश्यक मजदूर संख्या',
    workDateLabel: 'काम की तारीख',
    startTimeLabel: 'काम का समय',
    requiredSkillsLabel: 'आवश्यक कौशल',
    postWorkSubmit: 'काम प्रकाशित करें',
    postWorkSuccess: 'काम सफलतापूर्वक प्रकाशित हुआ!',
    applicantsTitle: 'उम्मीदवार / आवेदक',
    noApplicantsYet: 'अभी तक किसी का आवेदन नहीं आया है।',
    acceptWorker: 'स्वीकार करें',
    rejectWorker: 'अस्वीकार करें',
    workerAccepted: 'मजदूर स्वीकार किया गया',
    workerRejected: 'आवेदन अस्वीकृत',
    withdrawApplication: 'आवेदन वापस लें',
    withdrawConfirm: 'क्या आप यह आवेदन वापस लेना चाहते हैं?',
    markCompleted: 'काम पूरा दर्ज करें',
    confirmCompletion: 'काम पूरा होने की पुष्टि करें',
    rateWorker: 'मजदूर को रेटिंग दें',
    rateEmployer: 'मालिक को रेटिंग दें',
    submitRating: 'रेटिंग सबमिट करें',
    disputeTitle: 'शिकायत / विवाद दर्ज करें',
    disputeReason: 'शिकायत का कारण',
    disputeDescription: 'विस्तृत विवरण',
    submitDispute: 'शिकायत सबमिट करें',
    ...
    deleteService: 'सेवाएं हटाएं',
    deleteConfirm: 'क्या आप यह सेवा हटाना चाहते हैं?',
    allJobs: 'सभी काम',
    openJobs: 'खुले काम',
    inProgressJobs: 'जारी काम',
  ...
  en: {
    ...
    postWorkTitle: 'Post New Work',
    postWorkSubtitle: 'Directly connect with local workers in your village',
    jobTitleLabel: 'Job Title',
    jobTitlePlaceholder: 'e.g. Need farm laborers for weeding',
    jobDescLabel: 'Job Description',
    jobDescPlaceholder: 'Describe the work details clearly...',
    ...
    applicantsTitle: 'Applicants / Candidates',
